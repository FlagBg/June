...
{	
	...
	public function loadPage()
	{
		...
		$sql = "SELECT * FROM content, views WHERE (views.view_id=2 OR views.view_id = 0)
				AND views.view_status=1 AND content.content_status=1 
				AND views.view_id=content.content_viewId 
				ORDER BY content.content_key ASC;";	
	...
	private function renderView( $variables )
	{
		...
		$form	= file_get_contents( __DIR__ . '/../Views/home_loggedin/content.html' );
